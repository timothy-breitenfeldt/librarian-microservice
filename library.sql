...
CREATE TABLE `tbl_book_genres` (
  ...
  CONSTRAINT `fk_tbl_book_genres_tbl_genre1` FOREIGN KEY (`genreId`) REFERENCES `tbl_genre` (`genreId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `tbl_book_genres` (`genreId`, `bookId`) VALUES
(1,	2),
(1,	4),
(3,	2),
(4,	1),
